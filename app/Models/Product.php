...
class Product extends BaseModel
{
    ...
    protected $fillable = ['name', 'price', 'description', 'taxes','expense_account','income_account'];
    ...
    {
        return $this->belongsTo(ChartOfAccount::class, 'income_account');
    }
    //expense account
    public function expenseAccount(): BelongsTo
    {
        return $this->belongsTo(ChartOfAccount::class, 'expense_account');
    }
