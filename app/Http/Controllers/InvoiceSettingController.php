...
class InvoiceSettingController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        switch ($tab) {
            ...
            case 'payment':
                ...
                break;
            case 'expenses':
                $this->view = 'invoice-settings.ajax.expenese';
                break;
            default:
    ...
    public function update(UpdateInvoiceSetting $request)
    {
        ...
        $setting->expense_payable_account_id    = $request->expense_payable_account_id;
    ...
    public function updateExpenseSetting(){
        $setting = InvoiceSetting::where('company_id',company()->id)->first();
        $setting->expense_payable_account_id    = request()->expense_payable_account_id;
        $setting->save();
        return Reply::success(__('messages.updateSuccess'));
    }
