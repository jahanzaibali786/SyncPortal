...
class UniversalBundleController extends AccountBaseController
{
    ...
    public function installUniversalBundleModule(Request $request)
    {
        ...
        $module = 'Zoom';
        $modulePath = getUniversalBundleModulesPath() . '/' . $module;
        ...
        $appModule = Module::findOrFail($module);
        $appModule->enable();

        Artisan::call('module:migrate', array($module, '--force' => true));

        return Reply::success(__('universalbundle::app.moduleIsInstalling', ['module' => $module]));
    }
