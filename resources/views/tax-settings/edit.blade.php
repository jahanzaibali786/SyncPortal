                ...
                <x-forms.input-group>
                    <select class="form-control select-picker" name="chart_account_id" id="chart_account_id"
                        ...
                        @foreach ($accounts as $account)
                            <option value="{{ $account->id }}" @if ($tax->chart_of_account_id == $account->id) selected @endif>{{ $account->name }}</option>
                        @endforeach
                    </select>
                </x-forms.input-group>
            </div>
