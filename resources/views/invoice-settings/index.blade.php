                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            @endif
                            <a class="nav-item nav-link f-15 expenses" href="{{ route('invoice-settings.index') }}?tab=expenses"
                                role="tab" aria-controls="nav-ticketTypes" aria-selected="true">@lang('app.menu.expenseSettings')
                            </a>
            ...
            <x-slot name="buttons">
                <div class="row">
                    <div class="col-md-12  mb-3">
                        <x-forms.button-primary id="addUnitType" icon="plus"
                            class="addUnit btn btn-primary mb-2 actionBtn units-btn" type="button"
                            data-toggle="tooltip">@lang('app.addUnit')</x-forms.button-primary>
                        ...
                        <x-forms.button-primary id="add-payment-details" icon="plus"
                            class="addUnit btn btn-primary mb-2 actionBtn payment-btn" type="button" data-toggle="tooltip">
                            @lang('modules.invoices.addPaymentDetails')</x-forms.button-primary>
