            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-4 bank_name">
                        <x-forms.text fieldId="bank_name" :fieldLabel="__('modules.bankaccount.bankName')" fieldName="bank_name" fieldRequired="true"
                            :fieldPlaceholder="__('placeholders.bankaccount.bankName')">
                        </x-forms.text>
                    </div>

                    <div class="col-md-4">
                        <x-forms.text fieldId="account_name" :fieldLabel="__('modules.bankaccount.accountName')" fieldName="account_name"
                            fieldRequired="true" :fieldPlaceholder="__('placeholders.bankaccount.accountName')">
                        </x-forms.text>
                    </div>
                    ...
                    <div class="col-md-4">
                        <x-forms.select fieldId="currency_id" :fieldLabel="__('app.currency')" fieldName="currency_id" search="true"
                            fieldRequired="true">
                            <option value="">--</option>
                    ...
                    <div class="col-md-12 bankLogo">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2"
                            :fieldLabel="__('modules.bankaccount.bankLogo')" fieldName="bank_logo" fieldId="bank_logo" :popover="__('modules.themeSettings.logoSize')">
                        </x-forms.file>
                    </div>
