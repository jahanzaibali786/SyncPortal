...
@if (
    (!in_array('client', user_roles()) && !in_array('clients', user_modules())) ||
        (in_array('client', user_roles()) && !in_array('invoices', user_modules())))
        ...
        <x-form class="c-inv-form" id="saveInvoiceForm">
            ...
            <div class="row px-lg-4 px-md-4 px-3 py-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" id="exchange_rate" name="exchange_rate"
                        class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15"
                        value="{{ isset($estimateCurrency) ? $estimateCurrency?->exchange_rate : (isset($proposalCurrency) ? $proposalCurrency?->exchange_rate : $companyCurrency->exchange_rate) }}"
                        readonly>
            ...
            <div class="row px-lg-4 px-md-4 px-3 pt-3">
                ...
                <div class="col-md-4 mb-4 ">
                    ...
                    @else
                        <x-client-selection-dropdown :clients="$clients" :selected="isset($invoice)
                            ? $invoice->client_id
                        ...
                        <div class="select-others height-35 rounded">
                            <select class="form-control select-picker" data-live-search="true" data-size="8"
                                ...
                                <option value="after_discount"
                                    @if (isset($invoice) && $invoice->calculate_tax == 'after_discount') selected @elseif(isset($estimate) && $estimate->calculate_tax == 'after_discount') selected @endif>
                                    @lang('modules.invoices.afterDiscount')</option>
                                <option value="before_discount"
                                    @if (isset($invoice) && $invoice->calculate_tax == 'before_discount') selected @elseif(isset($estimate) && $estimate->calculate_tax == 'before_discount') selected @endif>
...
@endif
            ...
            <div class="row px-lg-4 px-md-4 px-3 py-3">
                <div class="col-md-3 d-none product-category-filter">
                    <div class="form-group c-inv-select mb-4">
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="category_id" id="product_category_id"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border-bottom-0 btrr-mbl btlr">
                                                <input type="text"
                                                    class="form-control f-14 border-0 w-100 item_name"
                                            ...
                                            <td class="border-bottom-0">
                                                ...
                                                @if (!is_null($item->product_id) && $item->product_id != 0)
                                                    ...
                                                    <input type="hidden" name="unit_id[]"
                                                        value="{{ $item->unit_id }}">
                                                @else
                                                    <select class="text-dark-grey float-right border-0 f-12"
                                                        name="unit_id[]">
                                                        @foreach ($units as $unit)
                                                            <option @selected($item->unit_id == $unit->id)
                                                                value="{{ $unit->id }}">{{ $unit->unit_type }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <tr class="d-none d-md-block d-lg-table-row">
                                            ...
                                            <td class="border-left-0">
                                                ...
                                                <input type="hidden" name="invoice_item_image_url[]"
                                                    value="{{ $item->invoiceItemImage ? $item->invoiceItemImage->file : '' }}">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <tr class="d-none d-md-block d-lg-table-row">
                                            ...
                                            <td class="border-left-0">
                                                @if (isset($type) && $type == 'proposal')
                                                    ...
                                                    <input type="hidden" name="invoice_item_image_url[]"
                                                        value="{{ $item->proposalItemImage ? $item->proposalItemImage->file : '' }}">
                                                @else
                                                    <input type="hidden" id="imageId_{{ $item->id }}"
                                                        class="itemOldImage" name="image_id[]"
                                                    ...
                                                    <input type="file" class="dropify itemImage"
                                                        ...
                                                        data-height="70" multiple />
                                                    <input type="hidden" name="invoice_item_image_url[]"
                                                        value="{{ $item->estimateItemImage ? $item->estimateItemImage->file : '' }}">
                                                @endif
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            ...
                                            <select class="text-dark-grey float-right border-0 f-12" name="unit_id[]">
                                                @foreach ($units as $unit)
                                                    <option @selected($unit->default == 1)
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="30%" align="left"
                                                                class="c-inv-sub-padding">
                                                                <div
                                                                    class="select-others select-tax height-35 rounded border-0">
                                                                    <select class="form-control select-picker"
                                                                        id="discount_type" name="discount_type">
                                                                        <option @selected(isset($invoice) && $invoice->discount_type == 'percent')
                                                                            value="percent">%
                                                                        </option>
                                                                        <option @selected(isset($invoice) && $invoice->discount_type == 'fixed')
                                                                            value="fixed">
            ...
            <div class="d-flex px-lg-4 px-md-4 px-3 py-2 bg-light-grey">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <x-forms.checkbox fieldId="payment_status" :fieldLabel="__('modules.invoices.receivedPayment')" fieldValue="0"
                                fieldName="payment_status"></x-forms.checkbox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 payment-types d-none">
                    <x-forms.text fieldId="transaction_id" :fieldLabel="__('modules.payments.transactionId')" fieldName="transaction_id"
        ...
        function saveForm(type, exceed) {
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        if (typeof invoiceDropzone !== 'undefined' && invoiceDropzone.getQueuedFiles().length >
                            0) {
                            invoiceID = response.invoiceID;
                            $('#invoiceID').val(response.invoiceID);
                            (response.add_more == true) ? localStorage.setItem("redirect_invoice", window
                                .location.href): localStorage.setItem("redirect_invoice", response
                                .redirectUrl);
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        let currencyExchange = (companyCurrencyName != currentCurrencyName) ? '( ' +
                            currentCurrencyName + ' @lang('app.to') ' + companyCurrencyName +
                            ' )' : '';
