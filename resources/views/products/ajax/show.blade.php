                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            {{-- //income accounts --}}
                            <x-cards.data-row :label="__('modules.accounts.incomeAccount')" :value="$product->incomeAccount->name ?? '--'" />
                            {{-- //expense accounts --}}
                            <x-cards.data-row :label="__('modules.accounts.expenseAccount')" :value="$product->expenseAccount->name ?? '--'" />
