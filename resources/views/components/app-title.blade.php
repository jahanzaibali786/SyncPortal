...
<div {{ $attributes->merge(['class' => 'page-title']) }}>
    <div class="page-heading">
        ...
        <span class="text-lightest f-12 f-w-500 mw-250 text-truncate" style="font-size: 12px !important">
            @if (user()?->is_superadmin)
                <a href="{{ route('superadmin.super_admin_dashboard') }}" class="text-lightest">@lang('app.menu.home')</a>
                &bull;
            @else
