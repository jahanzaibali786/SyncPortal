...
<x-auth>
    ...
    <form id="login-form" action="{{ route('login') }}" class="ajax-form" method="POST">
        ...
        <img class="rounded mb-4" src="{{ $globalSetting->logo_url }}" style="margin:auto; max-width: 250px;"
            alt="Logo" />


        <h2 class=" mb-4 f-w-500" style="text-align: left;">@lang('app.login')</h2>
        ...
        <div id="password-section">
            ...
            <div class="form-group text-left">
                ...
                <x-forms.input-group>
                    ...
                    <input type="password" name="password" id="password" placeholder="@lang('placeholders.password')" tabindex="3"
            ...
            <div class="auto-fill-grid three-buttons">
                ...
                <button type="button" class="btn btn-secondary" id="admin-login">Admin</button>

                <button type="button" class="btn btn-secondary" id="employee-login">Employee</button>

                <button type="button" class="btn btn-secondary" id="client-login">Client</button>
