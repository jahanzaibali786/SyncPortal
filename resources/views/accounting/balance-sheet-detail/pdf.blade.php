...
<body>
    <div class="header">
        ...
        <div class="report-title">Balance Sheet - Detail</div>
            ...
            <tr>
                ...
                <td class="amount">
                    @if($transaction->debit > 0)
                        <span class="debit">{{ number_format($transaction->debit, 2) }}</span>
                    @elseif($transaction->credit > 0)
                        <span class="credit">({{ number_format($transaction->credit, 2) }})</span>
                    @endif
                </td>
            </tr>
            @endforeach
