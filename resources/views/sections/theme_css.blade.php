<style>
    ...
    .sidebar-light .sidebar-menu li .nav-item:focus span,
    .sidebar-light .sidebar-menu li .nav-item:hover span,
    .sidebar-light .sidebar-menu li .accordionItemContent a:hover span {
